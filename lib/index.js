		...
		config.push({
			...
			rules: {
				...
				...(enableJsx ? {
					...
					// because the above is off
					//
					// return <div>
					// 	</div>
					//
					// eslint would complaint about the 2 tags are not on the same vertical line
					...
					// 	/>
					//
					// `<div` and `\>` are not on the same vertical line
					"@stylistic/jsx-closing-bracket-location": ["error", "after-props"], // also because the above is off
