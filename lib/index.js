...
/**
 * @param {{ enablePrettier?: boolean, enableJsx?: boolean, enableTs?: boolean }} options
 * @returns {Array<any>}
 * */
export default function hagemanto({ enablePrettier = true, enableJsx = true, enableTs = true } = {}) {
		...
		rules: {
			...enablePrettier ? {} : {
				...
				...enableJsx ? {
					...
					"@stylistic/jsx-curly-brace-presence": "never",
				} : {},
			},
		},
